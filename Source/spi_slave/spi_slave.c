...
{	
	...
	nrf_gpio_cfg_output(MTK_SPI_READY);//配置SPI从设备发送引脚
...
{
	DISABLE_PIN_FN(MTK_SPI_MISO)
	DISABLE_PIN_FN(MTK_SPI_CLK)
	DISABLE_PIN_FN(MTK_SPI_MOSI)
	DISABLE_PIN_FN(MTK_SPI_CS)
	DISABLE_PIN_FN(MTK_SPI_READY)
