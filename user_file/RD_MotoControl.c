...
#if defined(ADD_MT2503_CTRL)
void mt2503_power_ctrl(void)
{
	nrf_gpio_cfg_output(POWER_MTK2503_PIN);
	nrf_gpio_pin_set(RESET_MTK2503_PIN);
	nrf_delay_ms(3000);
	nrf_gpio_pin_clear(RESET_MTK2503_PIN);
}

void mt2503_rest_ctrl(void)
{
	nrf_gpio_cfg_output(RESET_MTK2503_PIN);
	nrf_gpio_pin_set(RESET_MTK2503_PIN);
	nrf_delay_ms(500);
	nrf_gpio_pin_clear(RESET_MTK2503_PIN);
}

void mt2503_vbat_ctrl(void)
{
	nrf_gpio_cfg_output(VBAT_CTRL_PIN);
	nrf_gpio_pin_set(VBAT_CTRL_PIN);
}


void mt2503_power_init(void)
{
	nrf_gpio_cfg_output(RESET_MTK2503_PIN);
	nrf_gpio_pin_clear(RESET_MTK2503_PIN);
	mt2503_vbat_ctrl();
